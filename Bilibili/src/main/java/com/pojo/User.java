...
public class User {
    ...
    private Collection<ReplyPost> replyPostsByUserId;
    ...
    public void setLastUpdate(Serializable lastUpdate) {
    ...
    public Collection<ReplyPost> getReplyPostsByUserId() {
        return replyPostsByUserId;
    }

    public void setReplyPostsByUserId(Collection<ReplyPost> replyPostsByUserId) {
        this.replyPostsByUserId = replyPostsByUserId;
    }
