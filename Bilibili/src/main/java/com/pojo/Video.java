...
public class Video {
    ...
    public Collection<Subscribe> getSubscribesByVideoId() {
        return subscribesByVideoId;
    }

    public void setSubscribesByVideoId(Collection<Subscribe> subscribesByVideoId) {
        this.subscribesByVideoId = subscribesByVideoId;
    }
