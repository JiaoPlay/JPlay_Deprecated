...
<html>
    ...
    <body id="wrapper" >
        ...
        <div id="no-mobile" style="position: fixed;top: 260px;right:0;width:10%;height:100%;">
            <nav>
                <ul>
        ...
        <!-- Don't show navi-column on mobile devices -->
        <script>
            var isOnPc=!(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent));
            if(!isOnPc) {
                document.getElementById("no-mobile").style.display = "none";
                document.getElementById("no-mobile").style.visibility="hidden";
            }
        </script>
    </body>
</html>