    ...
    <div class="profile">
        <div class="profile-table">
            ...
            <ul style="color: grey">
                ...
                <li><a href="#"><i class="fa fa-apple" style="color: #ff72c4"></i>&nbsp;我的上传</a></li>
            </ul>
        </div>
        <div class="profile-content">
            ...
            <div class="content">
                <table class="table table-responsive">
                    ...
                    <tbody>
                    <s:iterator value="videoBeanList" var="video">
                    <tr>
                        <TD class=forumrow>${video.videoId}</TD>
                        <TD class=forumrow>${video.title}</TD>
                        <TD class=forumrow>${video.content}</TD>
                    </tr>
                    </s:iterator>
